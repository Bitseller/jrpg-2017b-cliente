...
public class EstadoDePersonaje {
    ...
    public static void dibujarEstadoDePersonaje(final Graphics g, final int x, final int y, final Personaje personaje,
        ...
        g.drawString(String.valueOf(personaje.getSalud()) + " / " + String.valueOf(personaje.getSaludTope()), x + 132, y
            + 37);
    ...
    public static void dibujarEstadoDePersonaje(final Graphics g,
    		final int x, final int y, final PaquetePersonaje personaje,
        final BufferedImage miniaturaPersonaje) {
        ...
        g.drawString(String.valueOf(personaje.getSaludTope()) + " / " + String.valueOf(personaje.getSaludTope()), x
            + 132, y + 37);
