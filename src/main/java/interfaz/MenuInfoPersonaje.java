...
public class MenuInfoPersonaje {
    ...
    public void graficar(final Graphics g, final int tipoMenu) {
        ...
        // dibujo el personaje
        g.drawImage(Recursos.personaje.get(personaje.getRaza()).get(6)[0], x + MENU.getWidth() / 2 - ANCHO_PERSONAJE
            / 2, y + 70, 128, 128, null);
    ...
    public void graficarMenuInformacion(final Graphics g) {
        ...
        g.drawString(personaje.getExperiencia() + " / " + Personaje.getTablaDeNiveles()[personaje.getNivel() + 1], x
            + 150, y + 320);
