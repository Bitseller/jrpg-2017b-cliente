...
public class EstadoBatalla extends Estado {
    ...
    public EstadoBatalla(final Juego juego, final PaqueteBatalla paqueteBatalla) {
        ...
        juego.getEstadoJuego().setHaySolicitud(true, juego.getPersonaje(), MenuInfoPersonaje.MENU_PEDER_BATALLA);
                ...
                if (haySpellSeleccionada && seRealizoAccion) {
                    if (!enemigo.estaVivo()) {
                        ...
                        if (personaje.ganarExperiencia(enemigo.getNivel() * 40)) {
                            ...
                            juego.getPersonaje().setPuntosSkill(personaje.getPuntosSkill() + 3); // Actualiza
                                                                                                 // los
                                                                                                 // puntos
                                                                                                 // del
                                                                                                 // personaje.
